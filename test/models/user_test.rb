...
class UserTest < ActiveSupport::TestCase
  ...
  test "email addresses are stored in lowercase" do
    uppercased_email = @user.email.upcase
    @user.email = uppercased_email
    @user.save

    assert_equal uppercased_email.downcase, @user.reload.email
  end

  test "user without password isn't valid" do
    @user.password = nil
